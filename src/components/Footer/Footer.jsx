...
const Footer = () => {
	return (
		<>
			<div className='relative mt-[38rem] container max-w-[100%] mx-auto bg-green-700'>
				<img
					src={rectangle}
					className=' w-[1762.715px] h-[506.239px] absolute bottom-7 -z-10'
					alt=''
				/>
				<div className='relative'>
					...
					<div className='relative'>
						<p className='absolute bottom-[22rem] text-white left-[75rem] '>
							<a
								href=''
								className='footerLink absolute w-[274px] hover:text-[23px] h-[33px] text-[#fff] font-dm text-[20px] font-[700]'
							>
								SERVICES
							</a>
						</p>
						<p className='absolute bottom-[22rem] text-white left-[75rem] '>
							<a
								href=''
								className='footerLink absolute top-14 hover:text-[23px] w-[274px] h-[33px] text-[#fff] font-dm text-[20px] font-[700]'
							>
								APPROACH
							</a>
						</p>
						<p className='absolute bottom-[22rem] text-white left-[75rem] '>
							<a
								href=''
								className='footerLink absolute top-[7rem] hover:text-[23px] w-[274px] h-[33px] text-[#fff] font-dm text-[20px] font-[700]'
							>
								WORK
							</a>
						</p>
						<p className='absolute bottom-[22rem] text-white left-[75rem] '>
							<a
								href=''
								className='footerLink absolute top-[10rem] hover:text-[23px] w-[274px] h-[33px] text-[#fff] font-dm text-[20px] font-[700]'
							>
								CONTACT
							</a>
						</p>
