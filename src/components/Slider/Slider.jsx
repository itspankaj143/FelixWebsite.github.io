...
const Slider = () => {
	return (
		<div className='flex !h-[90vh] !w-[100%] border-2 border-red-500 justify-center '>
			...
			<div className='relative flex flex-col justify-evenly items-center border-2 border-red-500 w-[19.305rem]'>
			...
			<div className='relative border-2 border-red-500 flex justify-center items-center w-[19.305rem]'>
				<img src={img2} alt='' />
